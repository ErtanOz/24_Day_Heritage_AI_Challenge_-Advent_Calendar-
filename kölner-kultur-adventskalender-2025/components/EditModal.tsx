...
export const EditModal: React.FC<EditModalProps> = ({ dayData, isOpen, onClose, onSave }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fade-in">
      <div className="bg-white text-slate-900 rounded-xl shadow-2xl w-full max-w-md overflow-hidden border-4 border-red-700">
        <div className="bg-red-700 p-4 flex justify-between items-center text-white">
          <h2 className="text-xl font-bold font-christmas">Edit Day {dayData.day}</h2>
        ...
        <div className="p-6 space-y-4">
          <div>
            ...
            <input
              type="text"
              placeholder="e.g. Christmas Market at Dom"
            ...
            <p className="text-xs text-slate-500 mt-1">
              A short name for the day's surprise.
            </p>
          </div>

          <div>
            <label className="block text-sm font-semibold text-slate-700 mb-1">Image/GIF URL</label>
            <input
              type="url"
            ...
            />
            <p className="text-xs text-slate-500 mt-1">
              Leave empty to show the question mark (?).
            </p>
          </div>

          <div>
            <label className="block text-sm font-semibold text-slate-700 mb-1">Target Link URL</label>
            <input
              type="url"
            ...
            />
            <p className="text-xs text-slate-500 mt-1">
              Where should the user go when they click the image?
            </p>
          </div>
